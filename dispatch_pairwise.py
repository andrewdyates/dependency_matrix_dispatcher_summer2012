...
def dispatch_pairwise(tabfile=None, outdir=WORK_DIR, function=None, k=100000, dry=False, start_offset=0, work_dir=WORK_DIR, jobname=None, n_nodes=6, n_ppn=12, walltime='6:00:00'):
  assert tabfile
